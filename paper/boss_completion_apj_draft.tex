...
\begin{equation}
  ...
  \label{eq:graphgpz}
\end{equation}
All missing galaxies in realization $s$ share the same density-field estimate
and the same correlated prior draw, so their redshift assignments are
correlated.  We emphasize that this engine is a fast, robust field-level
